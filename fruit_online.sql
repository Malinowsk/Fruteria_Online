...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2023 a las 17:49:27
...
(1, 'pbkdf2_sha256$600000$u0TrQpbqHEbqiGQxIEt6Xc$vurfQWZ3rtP3ePAVXeKxq6NAdBC8U+791EzLK0AjRws=', '2023-05-12 16:33:26.348705', 1, 'admin', 'Juan', 'Rago', 'juan1234@gmail.com', 1, 1, '2023-05-03 01:44:04.000000'),
...
(4, 'pbkdf2_sha256$600000$4oJkLNtO2dJdOq9h0U5ATa$s05cl9FRWhYzO49VsNV/6pHgfJdnu9aGMiq+OKpCgzY=', '2023-05-12 16:34:47.346243', 0, 'messi10', 'Messi', 'Leonel', 'messi@gmail.com', 0, 1, '2023-05-12 11:57:37.349502');
...
--
-- Estructura de tabla para la tabla `fruteria_fruit`
--

CREATE TABLE `fruteria_fruit` (
  `id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `fruteria_fruit`
--

INSERT INTO `fruteria_fruit` (`id`, `name`, `photo`, `detail`, `description`, `price`, `max_quantity`) VALUES
...
(7, 'Naranaja Grajera', 'https://farm9.staticflickr.com/8299/7976295663_277dfa7841_o.jpg', 'Navelina', 'La naranja Navelina tiene el \"ombligo\" característico de las variedades de naranja navel pero éste es generalmente mas pequeño y abierto. Es una naranja de excelente calidad, su pulpa es suave y sabrosa y posee una considerable cantidad de jugo, por lo que también se utiliza coma naranja de zumo.', 170.00, 45),
...
--
-- Estructura de tabla para la tabla `fruteria_purchasecart`
--

CREATE TABLE `fruteria_purchasecart` (
  `id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `fruteria_purchasecart`
--

INSERT INTO `fruteria_purchasecart` (`id`, `quantity`, `state`, `purchase_code`, `fruit_id`, `user_id`) VALUES
(23, 4, 'en_proceso_de_compra', '6V2495H6AEASB7E', 5, 1),
(24, 8, 'en_proceso_de_compra', '6V2495H6AEASB7E', 3, 1),
(25, 5, 'en_proceso_de_compra', 'DD3LNP4K6L6P986', 5, 1),
(26, 3, 'en_proceso_de_compra', 'DD3LNP4K6L6P986', 2, 1),
(27, 3, 'en_proceso_de_compra', 'RSXEJGXS3XH1FJB', 2, 1),
(28, 4, 'en_proceso_de_compra', 'RSXEJGXS3XH1FJB', 3, 1),
(29, 4, 'en_proceso_de_compra', 'RSXEJGXS3XH1FJB', 5, 1),
(30, 4, 'en_proceso_de_compra', '646AJSUQ4D7VQGC', 2, 1),
(32, 4, 'en_proceso_de_compra', '6P1UAODDHIYNT62', 2, 1),
(33, 5, 'en_proceso_de_compra', '6P1UAODDHIYNT62', 1, 1),
(36, 2, 'en_proceso_de_compra', '6JO5DR0TBHY1KCF', 15, 4),
(37, 7, 'en_carrito', NULL, 5, 4),
(38, 4, 'en_carrito', NULL, 13, 4),
(39, 25, 'en_carrito', NULL, 10, 1),
(40, 5, 'en_carrito', NULL, 9, 1);
...
--
-- Indices de la tabla `fruteria_fruit`
--
ALTER TABLE `fruteria_fruit`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `fruteria_purchasecart`
--
ALTER TABLE `fruteria_purchasecart`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fruteria_purchasecart_fruit_id_ca5c3a55_fk_fruteria_fruit_id` (`fruit_id`),
  ADD KEY `fruteria_purchasecart_user_id_539193e4_fk_auth_user_id` (`user_id`);
...
--
-- AUTO_INCREMENT de la tabla `fruteria_fruit`
--
ALTER TABLE `fruteria_fruit`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `fruteria_purchasecart`
--
ALTER TABLE `fruteria_purchasecart`
...
--
-- Filtros para la tabla `fruteria_purchasecart`
--
ALTER TABLE `fruteria_purchasecart`
  ADD CONSTRAINT `fruteria_purchasecart_fruit_id_ca5c3a55_fk_fruteria_fruit_id` FOREIGN KEY (`fruit_id`) REFERENCES `fruteria_fruit` (`id`),
  ADD CONSTRAINT `fruteria_purchasecart_user_id_539193e4_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`);
COMMIT;

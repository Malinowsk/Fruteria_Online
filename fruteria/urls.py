...
from fruteria.views import presentar_home , presentar_catalogo , presentar_contacto , presentar_about , presentar_detail , presentar_mensaje, add_fruit, show_cart, delete_fruit, edit_fruit, get_purchase
...
urlpatterns = [
    ...
    path("cart/edit/<id>", presentar_detail ,  name='cart_edit'),

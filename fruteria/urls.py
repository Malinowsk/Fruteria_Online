...
from fruteria.views import presentar_home , presentar_catalogo , presentar_contacto , presentar_about , presentar_detail , presentar_mensaje, add_fruit, show_cart
